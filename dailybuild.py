...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="dailybuild.py")
    sub = parser.add_subparsers(dest="command", required=True)

    install_cron = sub.add_parser("install-cron", help="Install dailybuild cron jobs")
    ...
    run_openwrt = sub.add_parser("run-openwrt", help="Run an OpenWrt daily build")
    ...
    run_os = sub.add_parser("run-os", help="Run an OS daily build")
    ...
    run_zephyros = sub.add_parser("run-zephyros", help="Run a Zephyros daily build")
    ...
    upload_cmd.add_argument("--config", default="config/dailybuild_common.env")
    ...
    notify.add_argument("--config", default="config/dailybuild_common.env")
    ...
    show_config.add_argument("--config", default="config/dailybuild_common.env")
    ...
    set_config.add_argument("--config", default="config/dailybuild_common.env")
    ...
    show_status.add_argument("--config", default="config/dailybuild_common.env")
    ...
    interactive.add_argument("--config", default="config/dailybuild_common.env")
    ...
    status.add_argument("--config", default="config/dailybuild_common.env")
    ...
    list_jobs = sub.add_parser("list-jobs", help="Show daily cron jobs, one-time test state, and running dailybuild processes")
    list_jobs.add_argument("--config", default="config/dailybuild_common.env")
    ...
    tail_logs.add_argument("--config", default="config/dailybuild_common.env")
